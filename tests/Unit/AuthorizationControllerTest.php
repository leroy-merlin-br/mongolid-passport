...
class AuthorizationControllerTest extends TestCase
{
    ...
    public function test_request_is_approved_if_valid_token_exists()
    {
        ...
        $authRequest->shouldReceive('getClient')->once()->andReturn($clientEntity = m::mock(ClientEntityInterface::class));
        $authRequest->shouldReceive('getScopes')->once()->andReturn($scopes = [new Scope('scope-1')]);
